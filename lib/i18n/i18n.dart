...
class I18n implements WidgetsLocalizations {
  ...
  String get rate => "Bizi Değerlendir";

  String get update => "Uygulamayı Güncelle";
  ...
  String get descLang => "Dilinizi seçin";

  String get whoops => "Hata!";

  String get noInternet => "Internet bağlantısı yok";

  String get tryAgain => "Tekrar deneyin";

  String get closeApp => "Uygulamayı kapat";

  String get sureCloseApp => "Uygulamadan çıkmak istiyor musunuz ?";
  ...
  String get descriptionCustomize =>
      "Yedi Menü size daha iyi bir kullanıcı arayüzü özelleştirme deneyimi sağlar, kendi tema stilinizi seçmek ve projenize uygulamak kolaydır. Kullanıcı arayüzü alımınıza göre, Araç Çubuğu stili, sağ-sol düğme eylemi, uygulama Teması, yükleyici stilini seçin ve ardından değişiklikleri görmek için ana sayfaya geri dönün.";

  String get navigationBarStyle => "Gezinme çubuğu stili";

  String get headerType => "Başlık tipi";

  String get leftButtonOption => "Sol buton seçeneği";

  String get rightButtonOption => "Sağ buton seçeneği";

  String get colorGradient => "Gradient renk";

  String get colorSolid => "Solid renk";

  String get loadingAnimation => "Animasyonlar yükleniyor";

  String get backToHomePage => "Anasayfaya Dön";
...
class $tr extends I18n {
  ...
  @override
  String get descriptionCustomize =>
      "Yedi Menü size daha iyi UI özelleştirme deneyiminin gücünü verir, Kendi tema stilinizi seçmek ve projenize uymak kolaydır. Kullanıcı arayüzü işe alımınıza dayanarak, Araç Çubuğu stilini, soldaki düğme eylemini, uygulama Temasını, yükleyici stilini seçin.Daha sonra değişiklikleri görmek için eve dönün.";
